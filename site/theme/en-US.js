...
module.exports = {
  ...
  messages: {
    ...
    'app.home.introduce': 'Esenyun Open Platform platform has a variety of  templates, download template package, you can use it quickly, you can also use the  editor to quickly build a dedicated page for you.',
    'app.home.select-template': 'Templates',
    'app.home.enter-editor': 'Editor',
    'app.home.enter-doc': 'Docs',
    ...
    'app.home.fatures.authorize': 'Authorized',
    ...
    'app.home.slogan': 'Esenyun Open Platform Templates and Specifications',
